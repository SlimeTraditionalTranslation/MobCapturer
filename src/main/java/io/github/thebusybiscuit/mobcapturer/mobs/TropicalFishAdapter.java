...
public class TropicalFishAdapter implements MobAdapter<TropicalFish> {
	...
	public List<String> getLore(JsonObject json) {
		...
		lore.add(ChatColor.GRAY + "基本顏色: " + ChatColor.WHITE + StringUtils.format( json.get("baseColor").getAsString()));
		lore.add(ChatColor.GRAY + "樣式: " + ChatColor.WHITE + StringUtils.format( json.get("pattern").getAsString()));
		lore.add(ChatColor.GRAY + "樣式顏色: " + ChatColor.WHITE + StringUtils.format( json.get("patternColor").getAsString()));
