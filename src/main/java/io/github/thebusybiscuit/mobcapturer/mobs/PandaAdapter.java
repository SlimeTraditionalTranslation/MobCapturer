...
public class PandaAdapter extends AnimalsAdapter<Panda> {
	...
	public List<String> getLore(JsonObject json) {
		...
		lore.add(ChatColor.GRAY + "主要基因: " + ChatColor.WHITE + StringUtils.format(json.get("mainGene").getAsString()));
		lore.add(ChatColor.GRAY + "隱藏基因: " + ChatColor.WHITE + StringUtils.format(json.get("hiddenGene").getAsString()));
