...
public class MobCapturer extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        category = new Category(new NamespacedKey(this, "mob_capturer"), new CustomItem(SkullItem.fromHash("d429ff1d2015cb11398471bb2f895f7b4c3ccec201e4ad7a86ff24b744878c"), "&d生物捕捉器"));
        ...
        recipeType = new RecipeType(new NamespacedKey(this, "mob_capturing"), new CustomItem(cannon, "&6生物捕捉槍", "&7使用 &6生物捕捉槍", "&7來抓指令生物."));
