...
public class MobCapturer extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        if (cfg.getBoolean("options.auto-update") && getDescription().getVersion().startsWith("EFI - ")) {
            new GitHubBuildsUpdater(this, getFile(), "SlimeTraditionalTranslation/MobCapturer/master").start();
        }
        ...
        research = new Research(new NamespacedKey(this, "mob_capturing"), 32652, "神奇寶貝球", 28);

        SlimefunItemStack cannon = new SlimefunItemStack("MOB_CANNON", Material.BLAZE_ROD, "&6生物捕捉槍", "", "&e右鍵 &7來發射&f生物捕捉球");
        SlimefunItemStack pellet = new SlimefunItemStack("MOB_CAPTURING_PELLET", "983b30e9d135b05190eea2c3ac61e2ab55a2d81e1a58dbb26983a14082664", "&f生物捕捉球", "", "&7這些捕捉球用於", "&6生物捕捉槍");
        ...
        recipeType = new RecipeType(new NamespacedKey(this, "mob_capturing"), new CustomItemStack(cannon, "&6生物捕捉槍", "&7使用 &6生物捕捉槍", "&7來抓指令生物."));
        ...
        register("岩漿立方怪", EntityType.MAGMA_CUBE, new SlimeAdapter<>(MagmaCube.class), "1185657c38acdd8f95e1d2cd1115bb0f11139ad2b3ce442267e69706d916e");
        register("地獄幽靈", EntityType.GHAST, new StandardMobAdapter<>(Ghast.class), "c442c228f099fdfc1c6b46dfc80b252d81f7fb1739deb16ee7a597c17f7c9");
        if (Slimefun.getMinecraftVersion().isAtLeast(MinecraftVersion.MINECRAFT_1_16)) {
            register("豬布林", EntityType.PIGLIN, new PiglinAdapter(), "f2f621045771323d916c26bfb5ebec5738dbff8301246fe1481e9f9d25326f3b");
            register("豬布林蠻兵", EntityType.PIGLIN_BRUTE, new PiglinBruteAdapter(), "b13a4d678041dff776fffd96486e90f1b5e115af33647454caf401fd3fd00d5e");
            register("殭屍化豬布林", EntityType.ZOMBIFIED_PIGLIN, new ZombifiedPiglinAdapter(), "4db2e40571acefdcb7f15f94e1f174c3b9c299921f14da052628a0ba18e0c323");
            register("豬布獸", EntityType.HOGLIN, new HoglinAdapter(), "a6eddc5a25d4ff8f9f3490d673613093e65b866d369a26f8ee8b93983c692be3");
            register("豬屍獸", EntityType.ZOGLIN, new ZoglinAdapter(), "31a6d71f3587ad1888d757fea265614ab7d0204daade131954fb675e92585227");
            register("熾足獸", EntityType.STRIDER, new StriderAdapter(), "34f2759b413a8a645504fb5074dae1dddcc8af150b7fe06cc5832667e776b6f7");
        }
    ...
    public <T extends LivingEntity> void register(String name, EntityType type, MobAdapter<T> adapter, String eggTexture) {
        SlimefunItemStack itemstack = new SlimefunItemStack("MOB_EGG_" + type.toString(), eggTexture, "&a生物球 &7(" + name + ")", "", "&7右鍵此物品在方塊上", "&7來釋放你捉的生物");
